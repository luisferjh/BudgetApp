...
namespace Budget.Infrastructure.Migrations
{
    ...
    [Migration("20230517044253_default value in movements")]
    partial class defaultvalueinmovements
    {
            ...
            modelBuilder.Entity("Budget.Domain.Entities.LogError", b =>
                {
                    ...
                    b.Property<DateTime>("DateLog")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 5, 16, 23, 42, 52, 691, DateTimeKind.Local).AddTicks(7690))
            ...
            modelBuilder.Entity("Budget.Domain.Entities.Movement", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 5, 16, 23, 42, 52, 695, DateTimeKind.Local).AddTicks(936))
                        .HasColumnName("created_date");
            ...
            modelBuilder.Entity("Budget.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 5, 16, 23, 42, 52, 693, DateTimeKind.Local).AddTicks(5173))
                        .HasColumnName("created_date");
