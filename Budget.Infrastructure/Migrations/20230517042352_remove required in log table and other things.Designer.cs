...
namespace Budget.Infrastructure.Migrations
{
    ...
    [Migration("20230517042352_remove required in log table and other things")]
    partial class removerequiredinlogtableandotherthings
    {
            ...
            modelBuilder.Entity("Budget.Domain.Entities.LogError", b =>
                {
                    ...
                    b.Property<DateTime>("DateLog")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 5, 16, 23, 23, 51, 790, DateTimeKind.Local).AddTicks(8020))
            ...
            modelBuilder.Entity("Budget.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 5, 16, 23, 23, 51, 792, DateTimeKind.Local).AddTicks(1601))
                        .HasColumnName("created_date");
